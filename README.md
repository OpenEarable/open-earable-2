...
Solid red indicates a charging fault or inhibit. Firmware attempts one safety-timer recovery per USB connection; repeated faults require disconnecting USB before retrying.
