...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_RUNTIME_OBSERVERS_POOL_SIZE, 6);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LL_ACS_NRF53, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LE_AUDIO_MSG_SUB_STACK_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LE_AUDIO_MSG_SUB_QUEUE_SIZE, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_ADV_BUF_MAX, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_ADV_UUID_BUF_MAX, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_PUBLISH_STACK_SIZE, 300);
