...
void TWIM::begin(uint32_t speed) {
	int ret;
...
TWIM I2C(DEVICE_DT_GET(DT_NODELABEL(i2c1)));
TWIM I2C1(DEVICE_DT_GET(DT_NODELABEL(i2c2)));
TWIM I2C2(DEVICE_DT_GET(DT_NODELABEL(i2c3)));