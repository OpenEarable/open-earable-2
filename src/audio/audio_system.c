...
/* Eight 10 ms frames leave room in the Newlib heap for both LC3 sessions.
 * Sixteen frames reserve another 15 KB and exhaust that heap in the FOTA build.
 */
#define ENCODER_QUEUE_FRAME_COUNT 8
